      ...
      <div class="two "style="position:relative;left:400px;top:100px; ">
        <div class="register">
          ...
          <form id="reg-form1" method="POST">
            <div>
              <label for="name1" style="font-size:15px;">Category Name</label>
              <input type="text" style="font-size:12px;" name="name" id="name1" spellcheck="false" placeholder="Enter category name"/>
            </div>
            <div>
...
$insdata="insert into add_category(catagory_name,status)values('$cat_name','$cat_status')";
